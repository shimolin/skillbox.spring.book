...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, Event> kafkaOrderProducerFactory(ObjectMapper objectMapper){
    ...
    @Bean
    public KafkaTemplate<String, Event> kafkaTemplate(ProducerFactory<String, Event> kafkaOrderProducerFactory){
        return new KafkaTemplate<>(kafkaOrderProducerFactory);
    }

    @Bean
    ConsumerFactory<String, Order> kafkaOrderConsumerFactory(ObjectMapper objectMapper){
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Order> kafkaOrderConcurrentKafkaListenerContainerFactory(
            ConsumerFactory<String, Order> kafkaOrderConsumerFactory){
